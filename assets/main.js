  ...
  $('.js-form').submit(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        showModal('Comment submitted', 'Thanks! Your comment is <a href="https://github.com/KauntaOfficial/kauntaofficial.github.io/pulls">pending</a>. It will appear when approved.');
